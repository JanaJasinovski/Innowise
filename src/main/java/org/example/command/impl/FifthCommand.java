...
public class FifthCommand implements Command<IntegerCommandResult> {
    Service service = new ServiceImpl();
    @Override
    public IntegerCommandResult insertParameters(CommandParams commandParams) throws Exception {
        int integerValue = service.sumOfFirstNNaturalNumbersArePowers5(((FourthCommandData) commandParams).a);
