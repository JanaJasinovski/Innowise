...
public class FifteenthCommand implements Command<IntegerCommandResult> {
    Service service = new ServiceImpl();

    @Override
    public IntegerCommandResult insertParameters(CommandParams commandParams) throws Exception {
        int allNNaturalDivisors = service.sumOfPrimeNumbers(((FiveCommandData) commandParams).a, ((FiveCommandData) commandParams).array);
