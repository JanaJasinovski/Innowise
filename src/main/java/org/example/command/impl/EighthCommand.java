...
public class EighthCommand implements Command<IntegerCommandResult> {
    Service service = new ServiceImpl();
    @Override
    public IntegerCommandResult insertParameters(CommandParams commandParams) throws Exception {
        int integerValue = service.sumOfFirstNNaturalNumbersAreFullSquares(((FourthCommandData) commandParams).a);
